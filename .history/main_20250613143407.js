...
document.querySelector(".copyright").style.innerHTML = `<p>&copy; ${Date.now}  TechNovate. All rights reserved. Built with <i class="fas fa-heart"
                  style="color: #ff6b6b;"></i> by TechNovate Team</p>`