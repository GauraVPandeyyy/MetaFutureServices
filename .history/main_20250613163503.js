...
//         navbar.style.transition = 'all 0.1s linear';
//         // navbar.style.transition = 'all 0.01s cubic-bezier(0.4, 0.0, 0.2, 1)';
//     }, 100);
// });



  // Smooth scroll and auto-collapse navbar on link click (for mobile)
  document.querySelectorAll('.nav-link').forEach(anchor => {
    anchor.addEventListener('click', function (e) {
      ...
      if (target) {
        ...
        // Close the navbar on link click (if open)
  ...
  // Also close the navbar if user clicks anywhere outside it (on mobile)
