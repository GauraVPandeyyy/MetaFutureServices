...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.addEventListener("click", function (event) {
        ...
        if (!isClickInside && navbar.classList.contains("nav-open") && window.innerWidth < 992) {
...
#navbarContent.nav-open {
    max-height: 500px;
    opacity: 1;
}

/* Optional: smooth transform effect for nav links */
#navbarContent .nav-link {
    transition: transform 0.3s ease;
}

#navbarContent.nav-open .nav-link {
